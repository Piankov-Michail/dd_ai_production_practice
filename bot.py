...
FLOWISE_URL = "http://localhost:3000/api/v1/prediction/2b594714-a594-4a17-9cc2-6c5180758ccc"

OLLAMA_EMBEDDING_URL = "http://localhost:11434/api/embeddings"
EMBEDDING_MODEL = "nomic-embed-text:v1.5"

TELEGRAM_TOKEN = "7779420972:AAHNELc3xSP3LkjevKrZHH9C2R5ngnrBQIA"
BOT_USERNAME = "@SciphiSelfRagMistral7b32k_bot"
...
async def handle_image(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        description = image_processor.decode(out[0], skip_special_tokens=True)
        
        query = update.message.caption or os.path.splitext(photo_file.file_name)[0]

        await process_flowise_request(update, f"Описание изображения:\n{description}, Query: {query}")
